Module global
  ...
  real, allocatable :: kinetic(:,:), pot_c(:,:), pot_x(:,:)
  real, allocatable :: kappaC(:,:), kappaX(:,:)
  ...
  real :: r_pillar, g_pot
  real :: delta
  real :: kappa_C, kappa_X, sigma_p, k_p, kappa_out
  real :: f_p, omega_p
  ...
  NAMELIST /indata/               &
       ...
       &     r_pillar,             &   ! radius of the pillar
       &     g_pot,                &   ! strength of the hard wall potential
       &     kappa_out,            &   ! decay rate outside the pillar
